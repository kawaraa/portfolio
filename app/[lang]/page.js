...
const content = {
  ...
  hidden: {
    ...
    ar: [
      ...
      "نحن نقوم بجميع أنواع خدمات تطوير البرمجيات ونقوم بتطوير برمجي شامل متكامل والواجهة الأمامية وكذلك الخلفية مثل بناء الأنظمة، ومواقع الويب، وتطبيقات الويب، وتطبيقات أندرويد وايفون وصيانة الأداء، وإصلاح مواقع الويب، وتحديث مواقع الويب وتحريرها، دمج الأطراف الأخرى مع شوبيفاي، حلول التجارة الإلكترونية المخصصة، خدمات دمج واجهة برمجة، دمج إدارة المخزون، والكثير من الأشياء الأخرى.",
    ],
  },
  features: {
