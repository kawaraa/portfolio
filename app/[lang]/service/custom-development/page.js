...
const content = {
  ...
  sections: [
    {
      t: { en: "Understanding Custom Software Development", ar: "فهم تطوير البرمجيات المخصصة" },
      p: {
    ...
    {
      t: { en: "Tailored Solutions for Unique Challenges", ar: "حلول مصممة خصيصًا للتحديات الفريدة" },
      p: {
    ...
    {
      t: { en: "Scalability and Future-Proofing", ar: "قابلية التوسع والتدقيق في المستقبل" },
      p: {
    ...
    {
      t: { en: "Enhanced Security and Compliance", ar: "تعزيز الأمن والامتثال" },
      p: {
    ...
    {
      t: { en: "Optimized User Experience", ar: "تجربة المستخدم الأمثل" },
      p: {
    ...
    {
      t: { en: "Cost-Effectiveness in the Long Run", ar: "فعالية التكلفة على المدى الطويل" },
      p: {
    ...
    {
      t: { en: "Choosing the Right Development Partner", ar: "اختيار شريك التطوير المناسب" },
      p: {
