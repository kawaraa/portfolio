...
const content = {
  ...
  sections: [
    {
      h: { en: "Understanding the Essence of Software Consulting", ar: "فهم جوهر الاستشارات البرمجية" },
      p: {
    ...
    {
      h: { en: "Strategic Planning for Business Success", ar: "التخطيط الاستراتيجي لنجاح الأعمال" },
      p: {
    ...
    {
      h: { en: "Tailored Solutions for Every Business", ar: "حلول مخصصة لكل الأعمال" },
      p: {
    ...
    {
      h: { en: "Technology Expertise and Innovation", ar: "الخبرة التكنولوجية والابتكار" },
      p: {
    ...
    {
      h: { en: "Project Management and Implementation", ar: "إدارة المشاريع وتنفيذها" },
      p: {
    ...
    {
      h: { en: "Continuous Support and Adaptability", ar: "الدعم المستمر والقدرة على التكيف" },
      p: {
    ...
    {
      h: { en: "Maximizing Return on Investment (ROI)", ar: "تعظيم العائد على الاستثمار (ROI)" },
      p: {
    ...
    {
      h: { en: "Choosing Your Software Consulting Partner", ar: "اختيار شريكك الاستشاري في مجال البرمجيات" },
      p: {
