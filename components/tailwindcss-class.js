...
export const btnCls = `relative flex items-center justify-center rounded-full bg-pc hover:bg-sc p-3 tracking-wide text-white disabled:opacity-60 disabled:cursor-not-allowed duration-300`;
export const linkCls = "text-link hover:opacity-80 visited:opacity-60";
